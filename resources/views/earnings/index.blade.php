...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-bold">{{trans('lang.earning_plural')}}<small class="ml-3 mr-3">|</small><small>{{trans('lang.earning_desc')}}</small></h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        <li class="nav-item">
          <a class="nav-link active" href="{!! url()->current() !!}"><i class="fa fa-list mr-2"></i>{{trans('lang.earning_table')}}</a>
        </li>
        @can('earnings.create')
        <li class="nav-item">
