...
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    ...
    {{-- <!-- The long_time of people -->
    <div class="form-group row ">
        {!! Form::label('long_time', trans("lang.market_long_time"), ['class' => 'col-3 control-label text-right']) !!}
        <div class="col-9">
            {!! Form::number('long_time', null,  ['class' => 'form-control','placeholder'=>  trans("lang.market_long_time_placeholder"),'step'=>"any", 'min'=>"0"]) !!}
            <div class="form-text text-muted">
                {{ trans("lang.market_long_time_help") }}
            </div>
        </div>
    </div> --}}
        <!-- Start At Field -->
        {{-- <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
            {!! Form::label('expires_at', trans("lang.market_expires_at"), ['class' => 'col-md-3 control-label text-md-right mx-1']) !!}
            <div class="col-md-9">
                <div class="input-group datepicker expires_at" data-target-input="nearest">
                    {!! Form::text('expires_at', null,  ['class' => 'form-control datetimepicker-input','placeholder'=>  trans("lang.market_expires_at_placeholder"), 'data-target'=>'.datepicker.expires_at','data-toggle'=>'datetimepicker','autocomplete'=>'off']) !!}
                ...
                <div class="form-text text-muted">
                    {{ trans("lang.market_expires_at_help") }}
                </div>
            </div>
        </div> --}}
