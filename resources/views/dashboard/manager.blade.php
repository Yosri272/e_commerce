...
@section('content')
    ...
    <section class="content-header content-header{{setting('fixed_header')}}">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-bold">{{trans('lang.dashboard')}}<small class="mx-3"></small></h1>
                </div>
                <div class="col-sm-6">
    ...
    <div class="content">
        ...
        <div class="row">
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-white shadow-sm">
                    <div class="inner">
                        <h3 class="text-{{setting('theme_color','primary')}}">{{$ordersCount}}</h3>
            ...
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-white shadow-sm">
                    <div class="inner">
                        <h3 class="text-{{setting('theme_color','primary')}}">{{$marketsCount}}</h3>
        ...
        <div class="row">
            ...
            <!--                <a  class="text-{{setting('theme_color','primary')}}" href="{{route('payments.index')}}">{{trans('lang.dashboard_view_all_payments')}}</a>-->
            <!--            </div>-->
            <!--        </div>-->
            <!--        <div class="card-body">-->
            <!--            <div class="d-flex">-->
