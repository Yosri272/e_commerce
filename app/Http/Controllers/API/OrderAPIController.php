...
class OrderAPIController extends Controller
{
     ...
     * @param Request $request
     *
     * @return \Illuminate\Http\JsonResponseOrders retrieved successfully
     */
    ...
    private function cashPayment(Request $request){
        ...
        try {
            ...
            foreach ($input['product'] as $productOrder) {
                $productOrder['order_id'] = $order->id;
                $amount += $productOrder['price'] * $productOrder['quantity'];
                 $identification_market= $this->productOrderRepository->create($productOrder);
                /////////////// add identification and RandomId ///
            ...
            $this->orderRepository->update(['random_number' => $RandomId], $order->id);
